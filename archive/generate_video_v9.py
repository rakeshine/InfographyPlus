...
# Paths
image_path = "assets/testing/infographic.png"
cartoon_path = "assets/testing/man.gif"
text_folder = "assets/testing/texts"
...
def create_typewriter_dialogue_clip(full_text, cartoon_path=None, background_clip=None,
                                    dialogue_duration=2, bullet_icon_path="assets/images/spiral-11368_256.gif"):
...
for i, text_file in enumerate(text_files):
    ...
    dialogue = create_typewriter_dialogue_clip(text, cartoon_path, background_clip=blurred, dialogue_duration=dialogue_dur).crossfadein(0.6)
