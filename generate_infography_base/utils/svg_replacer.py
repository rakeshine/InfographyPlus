...
svg_config = MODULE_CONFIG['generate_infography_base']['functionalities']['svg-replacer']
SVG_INPUT = svg_config['input_svg']
JSON_INPUT = svg_config['input_json']
SVG_OUTPUT = svg_config['output']
