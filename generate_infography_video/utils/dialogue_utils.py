...
from .gif_utils import gif_to_transparent_clip
from .gif_utils import pixel_wrap
...
font_path = svg_config['font_path']
bullet_icon_path = svg_config['bullet_icon_path']
